...
/** Boxicons basic bx-award path, kept local because the React package does not export Award yet. */
export function AwardIcon({ removePadding: _removePadding, ...props }: BoxIconProps) {
  void _removePadding;
  return (
