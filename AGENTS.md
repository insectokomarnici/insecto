...
- Montserrat Variable is for headings; Manrope Variable for body text, navigation, CTA buttons and form controls. Both fonts are self-hosted through installed Fontsource packages.
